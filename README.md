...
| Proyecto | Área / Dominio | Stack Técnico | Repositorio |
| :--- | :--- | :--- | :--- |
...
### 🏗️ Arquitectura & Desarrollo de Software
- **Desarrollo Full Stack:** Diseño de interfaces modernas, APIs RESTful y aplicaciones escalables.
...
- **Diseño de Interfaz:** Prototipado interactivo y sistemas de diseño orientados a la usabilidad.
...
```text
├── assets/             # Recursos gráficos, capturas y diagramas de proyectos
├── components/         # Componentes reutilizables de la interfaz del portafolio
├── pages/              # Páginas del sitio (Inicio, Proyectos, Sobre mí, Contacto)
├── styles/             # Estilos globales y configuración de diseño (CSS/Tailwind)
